...
public class CardConstants {
	...
	public static final Card VALID_CARDDTO_ID_1L
	...
	public static final Card VALID_CARDDTO_UPDATED 
			= new Card(1L, "Birds of Paradise UPDATED", "Welcome to Magic: The Gathering! UPDATED...");
	
	public static final Card INVALID_CARDDTO_NULL 
			= new Card();
	
	public static final Card INVALID_CARDDTO_EMPTY_NAME_FIELD 
